...
import { SearchEngine } from "@understand-arch/core/search";
import type { SearchResult } from "@understand-arch/core/search";
import type { GraphIssue } from "@understand-arch/core/schema";
import type {
  GraphNode,
  KnowledgeGraph,
  TourStep,
} from "@understand-arch/core/types";
...
export type ViewMode = "structural" | "domain" | "architecture";
...
export interface ArchLayerSummary {
  ...
  technical_debt?: Array<Record<string, unknown>>;
...
interface DashboardStore {
  ...
  archLayer: ArchLayerSummary | null;
  activeDomainId: string | null;

  setDomainGraph: (graph: KnowledgeGraph) => void;
  setArchLayer: (layer: ArchLayerSummary) => void;
