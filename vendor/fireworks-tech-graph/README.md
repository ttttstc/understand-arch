...
```
fireworks-tech-graph/
├── PROMPT.md                     # Main skill — diagram types, layout rules, shape vocab
...
| Browser-generated SVG renders incorrectly | cairosvg / rsvg can't replay all CSS/JS-injected styles | Use the puppeteer script in `PROMPT.md` for 100% fidelity |
